...
def login():
	...
	try:
		...
		print "\033[1;95m      тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАв\033[1;96mBBadboi\033[1;95mтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
...
def menu():
	...
	os.system("clear") #Dev:Corona_Virus
...
def pilih_super():
	...
	print "  \033[1;91m┬л---тАвтЧИтАв---Developed By baloch-hacker--тАвтЧИтАв---┬╗" #Dev:Virus_Hacker
